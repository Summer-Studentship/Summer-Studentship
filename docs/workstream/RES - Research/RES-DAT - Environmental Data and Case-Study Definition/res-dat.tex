...
\input{"RES-DAT-GEO - Bathymetry, Topography and Coastal Geometry/res-dat-geo.tex"}
\input{"RES-DAT-SRC - Earthquake and Tsunami Source Data/res-dat-src.tex"}
\input{"RES-DAT-OBS - Observational and Validation Data/res-dat-obs.tex"}
\input{"RES-DAT-SCN - Scenario and Severity Definition/res-dat-scn.tex"}
\input{"RES-DAT-UNC - Data Quality, Uncertainty and Provenance/res-dat-unc.tex"}
\input{"RES-DAT-CAS - Integrated Tsunami Case-Study Specifications/res-dat-cas.tex"}
