...
\input{"RES-GEO-TAX - Barrier Geometry Taxonomy and Candidate Families/res-geo-tax.tex"}
\input{"RES-GEO-PAR - Parametric Geometry and Design-Variable Definition/res-geo-par.tex"}
\input{"RES-GEO-MET - Geometric and Hydraulic Descriptor Framework/res-geo-met.tex"}
\input{"RES-GEO-ARR - Barrier Arrangement, Placement and Spatial Configuration/res-geo-arr.tex"}
\input{"RES-GEO-REP - Two- and Three-Dimensional Model Representation/res-geo-rep.tex"}
\input{"RES-GEO-CST - Geometric Feasibility and Design Constraints/res-geo-cst.tex"}
\input{"RES-GEO-SPEC - Integrated Geometry-Generation Specification/res-geo-spec.tex"}
