...
\input{"RES-ML-ROL - Machine-Learning Role and Use-Case Definition/res-ml-rol.tex"}
\input{"RES-ML-DAT - Learning Dataset and Simulation-Data Requirements/res-ml-dat.tex"}
\input{"RES-ML-REP - Input, Output and Geometry Representation/res-ml-rep.tex"}
\input{"RES-ML-ALG - Learning Algorithm and Architecture Assessment/res-ml-alg.tex"}
\input{"RES-ML-OBJ - Loss Functions, Rewards and Physical Constraints/res-ml-obj.tex"}
\input{"RES-ML-SUR - Surrogate, Multifidelity and Active-Learning Strategy/res-ml-sur.tex"}
\input{"RES-ML-TRN - Training, Validation and Experiment Methodology/res-ml-trn.tex"}
\input{"RES-ML-GEN - Generalisation, Uncertainty and Interpretability/res-ml-gen.tex"}
\input{"RES-ML-INT - Integration with Simulation and Optimisation/res-ml-int.tex"}
\input{"RES-ML-SPEC - Integrated Machine-Learning Specification/res-ml-spec.tex"}
