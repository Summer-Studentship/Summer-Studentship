...
def build_scope_items(video: Mapping[str, Any]) -> list[dict[str, str]]:
    ...
    add("VID-11", "Video infrastructure", "hybrid preview MP4", "optional G6 hybrid assembly", "hybrid MP4", "not present", "NOT_APPLICABLE", "R14B allowed stopping after the accepted G6 Local3D preview when hybrid assembly became disproportionate; Local3D MP4 proves the reusable video path.", "Optional future outreach asset.")
